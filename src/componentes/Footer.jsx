...
export const Footer = () => {
  return (
    <>
      <footer className="bg-slate-400 text-white dark:bg-gray-90">
        <div className="mx-auto text-white w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between ">
            <div className="mb-6 md:mb-0 mr-8  ">
                ...
                <img
                  src="/img/pesca.webp"
                  className="   md:rounded-none rounded-full mt-16  "
                />
              
            </div>
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 ml-8 text-white ">
              <div>
                <h2 className="mb-6 text-2xl  font-semibold  uppercase text-slate-700">
                  Read More
                </h2>
                <ul className=" dark:text-gray-400 font-medium">
                  <li className="mb-4">
                    <a href="https://flowbite.com/" className="hover:underline-offset-4 hover:text-blue-500">
                      Impact Report(EN)
                    </a>
                  </li>
                  <li className="mb-4">
                  ...
                  <li>
                    <a
                      ...
                      className="hover:underline-offset-4 hover:text-blue-500"
                    >
                      Our Partners
                    </a>
                  </li>
              ...
              <div>
                <h2 className="mb-6 text-2xl  font-semibold text-slate-700 uppercase">
                  Policies
                </h2>
              ...
              <div>
                <h2 className="mb-6 text-sm font-semibold text-slate-700 uppercase dark:text-white">
                  JOIN THE MOVEMENT
                </h2>
                <ul className="text-gray-500 dark:text-gray-400 font-medium">
                  <li className="mb-4 text-slate-700">
                    Follow our mission and get updates straight from the field,
                    insights on how to protect the ocean and all things corals.
                  </li>
                  <li>
                    <a href="#" className="hover:underline-offset-4 hover:text-blue-500 text-white">
                      Terms &amp; Conditions
                    </a>
                  </li>
                </ul>
